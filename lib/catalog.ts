...
export const products: Product[] = [
  { id: 'livro-principal', name: 'O Caderno Esquecido', slug: 'caderno-esquecido', description: 'Receitas de família organizadas por ocasião e ingrediente.', price: 2790, compareAtPrice: 4790, category: 'Livro digital', active: true },
...
export const bundles: Bundle[] = [
  { id: 'essencial', name: 'Caderno Essencial', description: 'O livro principal para começar.', productIds: ['livro-principal'], price: 2790, compareAtPrice: 4790, cta: 'QUERO O CADERNO' },
  { id: 'familia', name: 'Coleção da Família', badge: 'MAIS ESCOLHIDO', description: 'Livro principal, sobremesas e receitas econômicas.', productIds: ['livro-principal', 'sobremesas', 'economicas'], price: 4790, compareAtPrice: 8330, cta: 'QUERO A COLEÇÃO', recommended: true },
  { id: 'completa', name: 'Acervo Completo', badge: 'MAIOR ECONOMIA', description: 'Todos os livros e o guia de ingredientes tradicionais.', productIds: ['livro-principal', 'sobremesas', 'economicas', 'ingredientes'], price: 5790, compareAtPrice: 9820, cta: 'QUERO O ACERVO COMPLETO' },
];
...
export const exitOffers = [
  ...
  { stage: 2, headline: 'Tereza separou uma opção mais completa', description: 'A Coleção da Família reúne três cadernos e inclui um índice de consulta rápida.', bundleId: 'familia', discountPercent: 0, cta: 'VER A COLEÇÃO' },
...
export const defaultSiteConfig = { heroBadge: 'RECEITAS GUARDADAS POR GERAÇÕES', heroTitle: 'O caderno de receitas que quase ficou esquecido na cozinha', heroSubtitle: 'Tereza reuniu preparos, anotações e conhecimentos de família em uma coleção digital simples de consultar no celular.', ctaText: 'ESCOLHER MINHA COLEÇÃO', urgencyText: 'Condição de lançamento disponível enquanto esta página estiver ativa.', seoTitle: 'Vovó Tereza | Receitas tradicionais em cadernos digitais', seoDescription: 'Receitas brasileiras, cadernos de família e conhecimentos tradicionais organizados para consultar no celular.' };
